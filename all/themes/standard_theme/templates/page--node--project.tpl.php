 ...
 */
?>
<div id="page" class="container page-node-project <?php print $classes; ?>">

  <!-- region: Leaderboard -->
  <?php print render($page['leaderboard']); ?>

  <!-- Add messages and local tabs at the top of the page -->
  <?php print $messages; ?>
